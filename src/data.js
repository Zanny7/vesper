...
export const GEAR = [
  ...
  // Shaman entries use the same slot order as the other healer rotations.
  {"id":"ch1-gravewater-conduit","owner":"shaman","slot":"Weapon","name":"Gravewater Conduit","chapter":1,"itemLevel":3,"icon":"/assets/items/ch1-gravewater-conduit.svg","flavor":"A slow current hums beneath the sealed crypt.","stats":{"spellPower":9,"maxHp":8}},
  {"id":"ch1-whispers-in-riverstone","owner":"shaman","slot":"Tome","name":"Whispers in Riverstone","chapter":1,"itemLevel":2,"icon":"/assets/items/ch1-whispers-in-riverstone.svg","flavor":"The ancestors speak through water worn marks.","stats":{"maxMana":50,"manaRegen":0.1}},
  {"id":"ch1-ancestral-shell","owner":"shaman","slot":"Trinket","name":"Ancestral Shell","chapter":1,"itemLevel":3,"icon":"/assets/items/ch1-ancestral-shell.svg","flavor":"A distant shore answers when the shell is held.","stats":{"manaRegen":0.55,"maxMana":8}},
  {"id":"ch1-mistcaller-cowl","owner":"shaman","slot":"Head","name":"Mistcaller Cowl","chapter":1,"itemLevel":1,"icon":"/assets/items/ch1-mistcaller-cowl.svg","flavor":"Cool mist gathers where the grave wind passes.","stats":{"maxHp":22,"resistance":1}},
  {"id":"ch1-spiritbound-hauberk","owner":"shaman","slot":"Chest","name":"Spiritbound Hauberk","chapter":1,"itemLevel":2,"icon":"/assets/items/ch1-spiritbound-hauberk.svg","flavor":"Quiet spirits keep watch between its scales.","stats":{"armor":1,"resistance":3,"maxHp":8}},
  {"id":"ch1-siltwalker-bindings","owner":"shaman","slot":"Legs","name":"Siltwalker Bindings","chapter":1,"itemLevel":1,"icon":"/assets/items/ch1-siltwalker-bindings.svg","flavor":"The river remembers every step toward home.","stats":{"armor":1,"maxHp":10}},
  {"id":"ch2-thunderreed-channeler","owner":"shaman","slot":"Weapon","name":"Thunderreed Channeler","chapter":2,"itemLevel":6,"icon":"/assets/items/ch2-thunderreed-channeler.svg","flavor":"A storm sleeps inside the hollow river reed.","stats":{"spellPower":16,"manaRegen":0.25}},
  {"id":"ch2-rainkeeper-tablets","owner":"shaman","slot":"Tome","name":"Rainkeeper Tablets","chapter":2,"itemLevel":5,"icon":"/assets/items/ch2-rainkeeper-tablets.svg","flavor":"Each carved line leads the rain back to earth.","stats":{"maxMana":90,"spellPower":3}},
  {"id":"ch2-stormcallers-bead","owner":"shaman","slot":"Trinket","name":"Stormcallers Bead","chapter":2,"itemLevel":6,"icon":"/assets/items/ch2-stormcallers-bead.svg","flavor":"A single bead holds the voice of summer rain.","stats":{"manaRegen":0.95,"maxHp":10,"resistance":1}},
  {"id":"ch2-cloudherd-headdress","owner":"shaman","slot":"Head","name":"Cloudherd Headdress","chapter":2,"itemLevel":4,"icon":"/assets/items/ch2-cloudherd-headdress.svg","flavor":"Small clouds follow the trail of its wearer.","stats":{"maxHp":38,"armor":1,"resistance":1}},
  {"id":"ch2-torrent-scaleguard","owner":"shaman","slot":"Chest","name":"Torrent Scaleguard","chapter":2,"itemLevel":5,"icon":"/assets/items/ch2-torrent-scaleguard.svg","flavor":"Rain runs between scales without reaching skin.","stats":{"armor":4,"maxHp":28}},
  {"id":"ch2-fordkeepers-greaves","owner":"shaman","slot":"Legs","name":"Fordkeepers Greaves","chapter":2,"itemLevel":4,"icon":"/assets/items/ch2-fordkeepers-greaves.svg","flavor":"The ford yields only to those who listen.","stats":{"resistance":4,"maxMana":20}},
  {"id":"ch3-cinderstorm-focus","owner":"shaman","slot":"Weapon","name":"Cinderstorm Focus","chapter":3,"itemLevel":9,"icon":"/assets/items/ch3-cinderstorm-focus.svg","flavor":"Fire and rain share a single restless heart.","stats":{"spellPower":24,"maxMana":10,"maxHp":10}},
  {"id":"ch3-songs-of-molten-rain","owner":"shaman","slot":"Tome","name":"Songs of Molten Rain","chapter":3,"itemLevel":8,"icon":"/assets/items/ch3-songs-of-molten-rain.svg","flavor":"The old storm songs survive on cooled stone.","stats":{"maxMana":120,"manaRegen":0.15,"resistance":1}},
  {"id":"ch3-emberheart-totem","owner":"shaman","slot":"Trinket","name":"Emberheart Totem","chapter":3,"itemLevel":9,"icon":"/assets/items/ch3-emberheart-totem.svg","flavor":"An ancestor keeps the last coal breathing.","stats":{"manaRegen":1.45,"spellPower":4}},
  {"id":"ch3-ashcloud-visor","owner":"shaman","slot":"Head","name":"Ashcloud Visor","chapter":3,"itemLevel":7,"icon":"/assets/items/ch3-ashcloud-visor.svg","flavor":"The storm reveals a path through falling ash.","stats":{"maxHp":50,"resistance":2,"armor":1}},
  {"id":"ch3-lavaward-scales","owner":"shaman","slot":"Chest","name":"Lavaward Scales","chapter":3,"itemLevel":8,"icon":"/assets/items/ch3-lavaward-scales.svg","flavor":"Each scale remembers the mountain before fire.","stats":{"resistance":7,"maxHp":35}},
  {"id":"ch3-obsidian-current-treads","owner":"shaman","slot":"Legs","name":"Obsidian Current Treads","chapter":3,"itemLevel":7,"icon":"/assets/items/ch3-obsidian-current-treads.svg","flavor":"Dark glass parts around the patient current.","stats":{"armor":6,"maxMana":25}},
  {"id":"ch4-moonstorm-scepter","owner":"shaman","slot":"Weapon","name":"Moonstorm Scepter","chapter":4,"itemLevel":12,"icon":"/assets/items/ch4-moonstorm-scepter.svg","flavor":"Its silver arc calls rain to the silent court.","stats":{"spellPower":33,"maxHp":15,"resistance":1}},
  {"id":"ch4-covenant-of-deep-waters","owner":"shaman","slot":"Tome","name":"Covenant of Deep Waters","chapter":4,"itemLevel":11,"icon":"/assets/items/ch4-covenant-of-deep-waters.svg","flavor":"The ancestors sealed their promise below the tide.","stats":{"maxMana":155,"spellPower":5}},
  {"id":"ch4-pearl-of-the-elder-tide","owner":"shaman","slot":"Trinket","name":"Pearl of the Elder Tide","chapter":4,"itemLevel":12,"icon":"/assets/items/ch4-pearl-of-the-elder-tide.svg","flavor":"An ancient tide turns within the pale pearl.","stats":{"manaRegen":2,"maxHp":15,"armor":1}},
  {"id":"ch4-nighttide-crown","owner":"shaman","slot":"Head","name":"Nighttide Crown","chapter":4,"itemLevel":10,"icon":"/assets/items/ch4-nighttide-crown.svg","flavor":"The turning tide bows to no earthly throne.","stats":{"maxHp":62,"armor":2,"resistance":2}},
  {"id":"ch4-tempest-courtmail","owner":"shaman","slot":"Chest","name":"Tempest Courtmail","chapter":4,"itemLevel":11,"icon":"/assets/items/ch4-tempest-courtmail.svg","flavor":"The storm stands guard beyond the courtly lamps.","stats":{"armor":8,"maxHp":55}},
  {"id":"ch4-starwater-legguards","owner":"shaman","slot":"Legs","name":"Starwater Legguards","chapter":4,"itemLevel":10,"icon":"/assets/items/ch4-starwater-legguards.svg","flavor":"Starlight follows the water through their seams.","stats":{"resistance":7,"maxMana":40}},
];
